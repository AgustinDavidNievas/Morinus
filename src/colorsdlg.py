...
class ColorsDlg(wx.Dialog):
	def __init__(self, parent):
		...
		self.btnFrame = buttons.GenButton(self, ID_BTN_Frame, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnSigns = buttons.GenButton(self, ID_BTN_Signs, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnAscMC = buttons.GenButton(self, ID_BTN_AscMC, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnHouses = buttons.GenButton(self, ID_BTN_Houses, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnHouseNumbers = buttons.GenButton(self, ID_BTN_HouseNumbers, '', size=(60, -1))
		...
		self.btnPositions = buttons.GenButton(self, ID_BTN_Positions, '', size=(60, -1))
		...
		self.btnDomicil = buttons.GenButton(self, ID_BTN_Domicil, '', size=(60, -1))
		...
		self.btnExal = buttons.GenButton(self, ID_BTN_Exal, '', size=(60, -1))
		...
		self.btnPeregrin = buttons.GenButton(self, ID_BTN_Peregrin, '', size=(60, -1))
		...
		self.btnCasus = buttons.GenButton(self, ID_BTN_Casus, '', size=(60, -1))
		...
		self.btnExil = buttons.GenButton(self, ID_BTN_Exil, '', size=(60, -1))
		...
		self.btnSun = buttons.GenButton(self, ID_BTN_Sun, '', size=(60, -1))
		...
		self.btnMoon = buttons.GenButton(self, ID_BTN_Moon, '', size=(60, -1))
		...
		self.btnMercury = buttons.GenButton(self, ID_BTN_Mercury, '', size=(60, -1))
		...
		self.btnVenus = buttons.GenButton(self, ID_BTN_Venus, '', size=(60, -1))
		...
		self.btnMars = buttons.GenButton(self, ID_BTN_Mars, '', size=(60, -1))
		...
		self.btnJupiter = buttons.GenButton(self, ID_BTN_Jupiter, '', size=(60, -1))
		...
		self.btnSaturn = buttons.GenButton(self, ID_BTN_Saturn, '', size=(60, -1))
		...
		self.btnUranus = buttons.GenButton(self, ID_BTN_Uranus, '', size=(60, -1))
		...
		self.btnNeptune = buttons.GenButton(self, ID_BTN_Neptune, '', size=(60, -1))
		...
		self.btnPluto = buttons.GenButton(self, ID_BTN_Pluto, '', size=(60, -1))
		...
		self.btnNodes = buttons.GenButton(self, ID_BTN_Nodes, '', size=(60, -1))
		...
		self.btnLoF = buttons.GenButton(self, ID_BTN_LoF, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnConjunctio = buttons.GenButton(self, ID_BTN_Conjunctio, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnSemisextil = buttons.GenButton(self, ID_BTN_Semisextil, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnSemiquadrat = buttons.GenButton(self, ID_BTN_Semiquadrat, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnSextil = buttons.GenButton(self, ID_BTN_Sextil, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnQuintile = buttons.GenButton(self, ID_BTN_Quintile, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnQuadrat = buttons.GenButton(self, ID_BTN_Quadrat, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnTrigon = buttons.GenButton(self, ID_BTN_Trigon, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnSesquiquadrat = buttons.GenButton(self, ID_BTN_Sesquiquadrat, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnBiquintile = buttons.GenButton(self, ID_BTN_Biquintile, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnQuinqunx = buttons.GenButton(self, ID_BTN_Quinqunx, '', size=(60, -1))
		...
		gsizer.Add(label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 2)
		self.btnOppositio = buttons.GenButton(self, ID_BTN_Oppositio, '', size=(60, -1))
