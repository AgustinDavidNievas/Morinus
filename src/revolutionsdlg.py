...
class RevolutionsDlg(wx.Dialog):
	def __init__(self, parent):
		super(RevolutionsDlg, self).__init__()
		...
		self.Create(parent, -1, mtexts.txts['Revolutions'], pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
