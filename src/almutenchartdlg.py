...
class AlmutenChartDlg(wx.Dialog):
	...
	def __init__(self, parent):
		super(AlmutenChartDlg, self).__init__()
		...
		self.Create(parent, -1, mtexts.txts['AlmutenOfTheChart'], pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
		...
		self.houselabels = []
		gsizer = wx.GridSizer(6, gap=wx.Size(0,0))
		...
		self.phaselabels = []
		gsizer = wx.GridSizer(3, gap=wx.Size(0,0))
