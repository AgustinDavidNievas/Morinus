...
#			calflag = astrology.SE_JUL_CAL
		jdN = radix.time.jd #astrology.julday(y, m, d, t, calflag)
...
#		print 'jdZ=%f' % jdZ
		...
		self.yz, self.mz, self.dz, self.tz = astrology.revjul(jdZ, 1) #cast a chart with this date and time for the natal place
