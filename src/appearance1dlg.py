...
class Appearance1Dlg(wx.Dialog):
	def __init__(self, parent):
		super(Appearance1Dlg, self).__init__()
		...
		self.Create(parent, -1, mtexts.txts['Appearance1'], pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
